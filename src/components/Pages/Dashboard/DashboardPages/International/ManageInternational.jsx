...
const ManageInternational = () => {
    const [international, refetch] = UseInternational();
    ...
    const handleAddPackage = () => {
        navigate('/dashboard/addinternational');
    };

    const handleEditPackage = (id) => {
        navigate(`/dashboard/updateinternational/${id}`);
    };
    ...
    const handleDeletePackage = async (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    const response = await axiosSecure.delete(`/international/${id}`);
    ...
    return (
        <div className='bg-white min-h-screen p-4 md:p-6 rounded-lg shadow'>
            <div className='flex flex-col md:flex-row md:items-center justify-between mb-6'>
                <h2 className='text-2xl font-bold text-sky-600 mb-4 md:mb-0'>Manage International Packages</h2>
                <button
...
export default ManageInternational;