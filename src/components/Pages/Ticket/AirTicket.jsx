                ...
                <div className="relative bg-gradient-to-r from-sky-800 to-indigo-900 py-16 md:py-24">
                    ...
                    <div className="container mx-auto px-4 relative z-10">
                        <div className="max-w-3xl mx-auto text-center">
                            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">Global <span className="text-purple-600">Ticket</span> Services</h1>
                            <p className="text-xl text-blue-100 mb-8">Buy Ticket and Explore Different Countries.</p>
                        </div>
                    </div>
                </div>
                <div>
                    <marquee className='text-5xl italic text-red-500 py-5' behavior="" direction="">Online Ticket Booking System Not Available Right Now !</marquee>
                </div>
                <div className="  py-20 bg-gradient-to-r from-teal-50 to-blue-50 rounded-2xl shadow-lg">
                    <div className="text-center space-y-6">
                        <h1 className="text-5xl font-bold text-sky-700 animate-bounce">
