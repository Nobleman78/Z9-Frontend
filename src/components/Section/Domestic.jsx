                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-12 items-center">
                        ...
                        <div className="order-1 md:order-2">
                            <h3 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-4 sm:mb-6">
                                Why <span className="text-sky-600">Choose</span> Our Domestic Tours?
                            </h3>
                            <ul className="space-y-3 sm:space-y-4">
                                <li className="flex items-start">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-base sm:text-lg text-gray-800 mb-1">Authentic Experiences</h4>
                                        <p className="text-gray-600 text-sm sm:text-base">Immerse yourself in local culture and traditions with our carefully curated itineraries.</p>
                                    </div>
                                </li>
                                <li className="flex items-start">
                                    <div className="bg-blue-100 p-1.5 sm:p-2 rounded-full mr-3 sm:mr-4 mt-0.5 sm:mt-1 flex-shrink-0">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-base sm:text-lg text-gray-800 mb-1">Value for Money</h4>
                                        <p className="text-gray-600 text-sm sm:text-base">Competitive pricing without compromising on quality or experiences.</p>
                                    </div>
                                </li>
                                <li className="flex items-start">
                                    <div className="bg-blue-100 p-1.5 sm:p-2 rounded-full mr-3 sm:mr-4 mt-0.5 sm:mt-1 flex-shrink-0">
                                    ...
                                    <div>
                                        <h4 className="font-semibold text-base sm:text-lg text-gray-800 mb-1">Sustainable Tourism</h4>
                                        <p className="text-gray-600 text-sm sm:text-base">We prioritize eco-friendly practices that support local communities.</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
